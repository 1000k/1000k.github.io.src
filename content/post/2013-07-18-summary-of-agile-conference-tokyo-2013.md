...
7/17 に開催された [Agile Conference tokyo 2013](http://pw.tech-arts.co.jp/act2013/) に参加してきました。10時から18時までひたすら座学で激しく消耗しましたが、得るものも多かったです。
...
SAFe とは、企業規模でリーンとアジャイルのプラクティスを実現するためのフレームワーク。[Scaled Agile Framework](http://scaledagileframework.com/) で公開されている。
